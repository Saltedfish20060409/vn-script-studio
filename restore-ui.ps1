...
$paths = @(
  ...
  "frontend/src/lib/focusMode.ts",
  "frontend/src/lib/mascotCopy.ts",
  "frontend/src/lib/writerPortraits.ts",
  "frontend/public/writers",
  ...
  "frontend/src/components/FocusChrome.tsx",
  "frontend/src/components/FocusChrome.module.css",
  "frontend/src/components/MascotFigure.tsx",
  "frontend/src/components/MascotFigure.module.css",
  "frontend/src/components/WriterPortrait.tsx",
  "frontend/src/components/WriterPortrait.module.css",
  ...
  "frontend/src/components/AnalysisPanels.module.css",
  "frontend/src/components/VoiceStudio.module.css",
