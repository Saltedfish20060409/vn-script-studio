...
| 《「讀」與「玩」的邊界消融：文字小說改編為視覺小說的實踐與敘事重構分析》 | **未核实**（刊名/年份/期号待确认） | 小说 → VN 改编实践与叙事重构 | 暂不落库；能核实时再补 |
| 《叙事、创作、接受：构建视觉小说美学的三个维度》（中国现代文学论丛 2025(1)） | **未核实** | VN 美学的三个维度（叙事/创作/接受） | 暂不落库；我们的三层（结构量 / 工具与写作 / 试玩遥测与盲测）与它同类 |
...
- [ ] 未核实待补：《「讀」與「玩」的邊界消融：文字小說改編為視覺小說的實踐與敘事重構分析》
      （刊名/年份/期号未确认）、《叙事、创作、接受：构建视觉小说美学的三个维度》
      （刊名/期号未确认）——先不落库，能核实时再补
