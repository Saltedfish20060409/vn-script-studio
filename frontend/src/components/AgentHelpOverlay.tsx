...
1. **章节摘要**：每次保存时自动抽取（章梗概、出场角色、开场/收束钩子），不调模型、不额外花额度。
2. **写作账本**：同样在保存时自动更新——每章的事实、每个角色的情绪与最近动作、章末钩子记为**未回收伏笔**。这些会作为「项目硬锚」自动写进责编的上下文，让续写和审稿不跑偏。

想看它记住了什么：**项目 → 账本 / 摘要**，可以逐章翻开对照、按角色看状态历史。不再需要说「更新账本」这类指令。
